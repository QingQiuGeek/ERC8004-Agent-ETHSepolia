...
const AGENT_CONFIG = {
  ...
  a2aEndpoint: 'https://qingqiuagent.example.com/.well-known/agent-card.json',
  mcpEndpoint: 'https://qingqiuagent.example.com/mcp',
};
...
async function main() {
  ...
  const walletTx = await agent.setWallet('0x58D13f8E11C283C34D17A8775377ddc753236BA2');
